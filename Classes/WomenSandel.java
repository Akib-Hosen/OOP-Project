...
public class WomenSandel
{
	...
	WomenSandel()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/san3.jpg"));
		l3 = new JLabel("Casual");
		l4 = new JLabel("Brand: Walker");
		l5 = new JLabel("Size: 6-10");
		l6 = new JLabel("Price: 2080tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/san2.jpg"));
		l9 = new JLabel("Belt");
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/san4.jpg"));
		l15 = new JLabel("Slite");
		l16 = new JLabel("Brand: Lotto");
		l17 = new JLabel("Size :6-9");
		l18 = new JLabel("Price: 750tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/san1.jpg"));
		l21 = new JLabel("Semi Cover");
		l22 = new JLabel("Brand: Appex");
		l23 = new JLabel("Size :6-9");
