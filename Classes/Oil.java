...
public class Oil
{
	...
	Oil()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/foil.jpg"));
		l3 = new JLabel("Soyabean Oil");
		l4 = new JLabel("Brand: Fresh");
		l5 = new JLabel("Weight: 5 Litre");
		l6 = new JLabel("Price: 910tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/muskan.jpg"));
		l9 = new JLabel("Soyabean Oil");
		l10 = new JLabel("Brand: Muskan");
		l11 = new JLabel("Weight: 2 Litre");
		l12 = new JLabel("Price: 390tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/teer.jpg"));
		l15 = new JLabel("Soyabean Oil");
		l16 = new JLabel("Brand: Teer");
		l17 = new JLabel("Weight: 5Litre");
		l18 = new JLabel("Price: 960tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/radhuni.jpg"));
		l21 = new JLabel("Mustard Oil");
		l22 = new JLabel("Brand: Radhuni");
		l23 = new JLabel("Weight: 1kg");
		l24 = new JLabel("Price: 280tk");
