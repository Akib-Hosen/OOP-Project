...
public class Powerbank
{
	...
	Powerbank()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/bpb.jpg"));
		l3 = new JLabel("");
		l4 = new JLabel("Brand: Boat");
		l5 = new JLabel("Capacity: 10000mHz");
		l6 = new JLabel("Price: 2000tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/mi.jpg"));
		l9 = new JLabel("");
		l10 = new JLabel("Brand: MI");
		l11 = new JLabel("Capacity : 9mHz");
		l12 = new JLabel("Price: 1800tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/opb.jpg"));
		l15 = new JLabel("");
		l16 = new JLabel("Brand: Remax");
		l17 = new JLabel("Capacity : 12000mHz");
		l18 = new JLabel("Price: 1350tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/upb.jpg"));
		l21 = new JLabel("");
		l22 = new JLabel("Brand: Huawei");
		l23 = new JLabel("Capacity : 9mHz");
		l24 = new JLabel("Price: 1690tk");
