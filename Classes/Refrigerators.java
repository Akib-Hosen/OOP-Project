...
public class Refrigerators
{
	...
	Refrigerators()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/gf.jpg"));
		l3 = new JLabel("Double Door");
		l4 = new JLabel("Brand: Gree");
		l5 = new JLabel("Size: 450Liter");
		l6 = new JLabel("Price: 75000tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/lf.jpg"));
		l9 = new JLabel("Duel Mode");
		l10 = new JLabel("Brand: LG");
		l11 = new JLabel("Size :280Liter");
		l12 = new JLabel("Price: 46000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/wf.jpg"));
		l15 = new JLabel("GlassDoor");
		l16 = new JLabel("Brand:Waltone");
		l17 = new JLabel("Size :220Liter");
		l18 = new JLabel("Price: 25000tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/hf.jpg"));
		l21 = new JLabel("Smart Inverter");
		l22 = new JLabel("Brand: Haier");
		l23 = new JLabel("Size :250Liter");
		l24 = new JLabel("Price: 68000tk");
