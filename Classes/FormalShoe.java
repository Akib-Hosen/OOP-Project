...
public class FormalShoe
{
	...
	FormalShoe()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/afs.jpg"));
		l3 = new JLabel("Black Formal Shoe");
		l4 = new JLabel("Brand: Apex");
		l5 = new JLabel("Size: 9-10");
		l6 = new JLabel("Price: 3250tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/bfs.jpg"));
		l9 = new JLabel("Brown Formal Shoe");
		l10 = new JLabel("Brand: Bata");
		l11 = new JLabel("Size :8-10");
		l12 = new JLabel("Price: 2600tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/bay.jpg"));
		l15 = new JLabel("Oxford Shoes");
		l16 = new JLabel("Brand: Bay");
		l17 = new JLabel("Size :6-9");
		l18 = new JLabel("Price: 1450tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/gucchi.jpg"));
		l21 = new JLabel("Premium Formal Shoes");
		l22 = new JLabel("Brand: Gucci");
		l23 = new JLabel("Size :8-10");
		l24 = new JLabel("Price: 42900tk");
