...
public class WaterPurifier
{
	...
	WaterPurifier()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/pu.jpg"));
		l3 = new JLabel("Pureit R/o");
		l4 = new JLabel("Brand: Uniliver");
		l5 = new JLabel("Size: 23Liter");
		l6 = new JLabel("Price: 19000tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/dwp.jpg"));
		l9 = new JLabel("Manual Filter");
		l10 = new JLabel("Brand: Rekit");
		l11 = new JLabel("Size: 29Liter");
		l12 = new JLabel("Price: 7000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/dkit.jpg"));
		l15 = new JLabel("Drinkit Automatic Germkiller");
		l16 = new JLabel("Brand: P&G");
		l17 = new JLabel("Capacity: 2500Liter");
		l18 = new JLabel("Price: 18000tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/swc.jpg"));
		l21 = new JLabel("Industrial purifier");
		l22 = new JLabel("Brand: Safe Water");
		l23 = new JLabel("Capacity : 9000Liter");
		l24 = new JLabel("Price: 13990tk");
		...
		b1.setBounds(340,290,170,30);
		b3.setBounds(960,290, 170, 30);
		b4.setBounds(340,540, 170, 30);
