...
public class TV
{
	...
	TV()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/ltv.jpg"));
		l3 = new JLabel("Smart TV");
		l4 = new JLabel("Brand: LG");
		l5 = new JLabel("Seize: 39inch");
		l6 = new JLabel("Price: 30800tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/stv.jpg"));
		l9 = new JLabel("Android TV");
		l10 = new JLabel("Brand: Sony");
		l11 = new JLabel("Size : 52inch");
		l12 = new JLabel("Price: 46000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/ptv.jpg"));
		l15 = new JLabel("OLED");
		l16 = new JLabel("Brand: Panasonic");
		l17 = new JLabel("Size : 48inch");
		l18 = new JLabel("Price: 35000tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/wtv.jpg"));
		l21 = new JLabel("Android TV");
		l22 = new JLabel("Brand: Walton");
		l23 = new JLabel("Size : 36inch");
		l24 = new JLabel("Price: 23990tk");
