...
public class Snacks
{
	...
	Snacks()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/alooz.jpg"));
		l3 = new JLabel("Chips");
		l4 = new JLabel("Brand: Bombay Sweets");
		l5 = new JLabel("Weight: 35gm");
		l6 = new JLabel("Price: 20tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/chanachur.jpg"));
		l9 = new JLabel("Chanachur");
		l10 = new JLabel("Brand: Ruchi");
		l11 = new JLabel("Weight: 250");
		l12 = new JLabel("Price: 80tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/elachi.jpg"));
		l15 = new JLabel("Biscuits");
		l16 = new JLabel("Brand: Biscoti");
		l17 = new JLabel("Weight: 250gm");
		l18 = new JLabel("Price: 100tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/7up.jpg"));
		l21 = new JLabel("Cold Drinks");
		l22 = new JLabel("Brand: 7up");
		l23 = new JLabel("Weight: 1litre");
		l24 = new JLabel("Price: 65tk");
