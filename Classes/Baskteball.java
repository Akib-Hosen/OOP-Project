...
public class Baskteball
{
	...
	Baskteball()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/Baskteball.jpg"));
		l3 = new JLabel("Baskte");
		l4 = new JLabel("Brand: Humar");
		l5 = new JLabel("Weight: 2kg");
		l6 = new JLabel("Price: 550tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/ball2.jpg"));
		l9 = new JLabel("Ball");
		l10 = new JLabel("Brand: SS");
		l11 = new JLabel("Weight: 600gm");
		l12 = new JLabel("Price: 1000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/Cap.jpg"));
		l15 = new JLabel("Cap");
		l16 = new JLabel("Brand: Humar");
		l17 = new JLabel("Weight: 700gm");
		l18 = new JLabel("Price: 1200tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/Equipment3.jpg"));
		l21 = new JLabel("Baskteball Stand");
		l22 = new JLabel("Brand: Provita");
		l23 = new JLabel("Weight: 30kg");
		l24 = new JLabel("Price: 8000tk");
