...
public class PhoneCases
{
	...
	PhoneCases()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/lpc.jpg"));
		l3 = new JLabel("Silicon Case");
		l4 = new JLabel("Brand: Xiaomi");
		l5 = new JLabel("Seize: XXL");
		l6 = new JLabel("Price: 780tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/mpc.jpg"));
		l9 = new JLabel("Silicon Case");
		l10 = new JLabel("Brand: Oppo");
		l11 = new JLabel("Size : XL");
		l12 = new JLabel("Price: 600tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/spc.jpg"));
		l15 = new JLabel("Silicon Case");
		l16 = new JLabel("Brand: VIVO");
		l17 = new JLabel("Size : L");
		l18 = new JLabel("Price: 450tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/vpc.jpg"));
		l21 = new JLabel("Silicon Case");
		l22 = new JLabel("Brand: Apple");
		l23 = new JLabel("Size : XL");
		l24 = new JLabel("Price: 390tk");
