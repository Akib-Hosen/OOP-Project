...
public class Cricket
{
	...
	Cricket()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/Bat.jpg"));
		l3 = new JLabel("Bat");
		...
		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/ball.jpg"));
		l9 = new JLabel("Ball");
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/helmet.jpg"));
		l15 = new JLabel("Helmet");
