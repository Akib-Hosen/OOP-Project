...
public class FormalShirt
{
	...
	FormalShirt()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/k3.jpg"));
		l3 = new JLabel("Shirt");
		l4 = new JLabel("Brand: Orobindu");
		l5 = new JLabel("Size: M,L,S,XL,XLL");
		l6 = new JLabel("Price: 650tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/k5.jpg"));
		l9 = new JLabel("Shirt");
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/K7.jpg"));
