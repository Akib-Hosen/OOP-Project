...
public class Fruits
{
	...
	Fruits()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/banana.jpg"));
		l3 = new JLabel("SHobri Kola");
		l4 = new JLabel("");
		l5 = new JLabel("");
		l6 = new JLabel("Price: 150tk Dozen");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/mango.jpg"));
		l9 = new JLabel("Langra Aam");
		l10 = new JLabel("");
		l11 = new JLabel("Weight: 5kg");
		l12 = new JLabel("Price: 550tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/apple.jpg"));
		l15 = new JLabel("Kashmiri Apple");
		l16 = new JLabel("");
		...
		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/orange.jpg"));
		l21 = new JLabel("Sylheti Orange");
		l22 = new JLabel("");
		l23 = new JLabel("Weight: 1kg");
		l24 = new JLabel("Price: 120tk");
