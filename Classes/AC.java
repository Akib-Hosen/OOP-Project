...
public class AC
{
	...
	AC()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/gac.jpg"));
		l3 = new JLabel("Inverter");
		l4 = new JLabel("Brand: Gree");
		l5 = new JLabel("Size: 2Ton");
		l6 = new JLabel("Price: 82000tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/lac.jpg"));
		l9 = new JLabel("Hot & Coolt");
		l10 = new JLabel("Brand: LG");
		l11 = new JLabel("Size :1.5Ton");
		l12 = new JLabel("Price: 86000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/wac.jpg"));
		l15 = new JLabel("Inverter");
		l16 = new JLabel("Brand: Walton");
		l17 = new JLabel("Size :1.5Ton");
		l18 = new JLabel("Price: 75000tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/sac.jpg"));
		l21 = new JLabel("Dual Inverter");
		l22 = new JLabel("Brand: Singer");
		l23 = new JLabel("Size :2Ton");
		l24 = new JLabel("Price: 79990tk");
