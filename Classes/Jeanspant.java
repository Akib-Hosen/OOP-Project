...
public class  Jeanspant
{
	...
	Jeanspant()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/p.jpg"));
		l3 = new JLabel("pant");
		...
		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/p1.jpg"));
		l9 = new JLabel("pant");
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/p2.jpg"));
		l15 = new JLabel("pant");
		...
		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/p3.jpg"));
		l21 = new JLabel("pant");
		l22 = new JLabel("Brand: victor");
		l23 = new JLabel("Size: M,L,S,XL,XLL");
		l24 = new JLabel("Price: 3450tk");
