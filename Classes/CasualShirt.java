...
public class CasualShirt
{
	...
	CasualShirt()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/k.jpg"));
		l3 = new JLabel("Shirt");
		...
		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/k2.jpg"));
		l9 = new JLabel("Shirt");
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/k6.jpg"));
		l15 = new JLabel("Shirt");
		...
		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/k5.jpg"));
		l21 = new JLabel("Shirt");
