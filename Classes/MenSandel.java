...
public class MenSandel
{
	...
	MenSandel()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/bs1.jpg"));
		...
		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/bs2.jpg"));
		l9 = new JLabel("Belt");
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/bs3.jpg"));
		...
		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/bs4.jpg"));
