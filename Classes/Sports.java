...
public class Sports
{
    ...
    Sports()
    {
        ...
        //construct component
        l1 = new JLabel("Sports Accessories");
        l2 = new JLabel("Select your product");
		l3 = new JLabel("Cricket");
		l4 = new JLabel("Football");
		l5 = new JLabel("Baskteball");
		l6 = new JLabel("Badminton");
		l7 = new JLabel("Tennis");
		l8 = new JLabel("Jersey");




        b1 = new JButton();
        b1.setIcon(new ImageIcon("image/cricket.jpg"));
		b2 = new JButton();
        b2.setIcon(new ImageIcon("image/football.jpg"));
        b3 = new JButton();
        b3.setIcon(new ImageIcon("image/basketball.jpg"));
        b4 = new JButton();
        b4.setIcon(new ImageIcon("image/badminton.jpg"));
        b5 = new JButton();
        b5.setIcon(new ImageIcon("image/tennis.jpg"));
        b6 = new JButton();
        b6.setIcon(new ImageIcon("image/jersey.jpg"));
        b7 = new JButton();
