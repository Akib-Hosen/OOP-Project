...
public class Drives
{
	...
	Drives()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/pen4.jpg"));
		l3 = new JLabel("Pendrive");
		l4 = new JLabel("Brand: HP");
		l5 = new JLabel("Size: 16gb");
		l6 = new JLabel("Price: 800tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/pen.jpg"));
		l9 = new JLabel("Pendrive");
		l10 = new JLabel("Brand: RoboTube");
		l11 = new JLabel("Size : 32gb");
		l12 = new JLabel("Price: 1020tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/pen2.jpg"));
		l15 = new JLabel("Pendrive");
		l16 = new JLabel("Brand: HP");
		l17 = new JLabel("Size : 16gb");
		l18 = new JLabel("Price: 750tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/pen3.jpg"));
		l21 = new JLabel("Pendrive");
		l22 = new JLabel("Brand: Samsung");
		l23 = new JLabel("Size : 64");
		l24 = new JLabel("Price: 1600tk");
