...
public class SmartWatch
{
	...
	SmartWatch()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/asw.jpg"));
		l3 = new JLabel("");
		l4 = new JLabel("Brand: Apple");
		l5 = new JLabel("Model: 13");
		l6 = new JLabel("Price: 29990tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/bsw.jpg"));
		l9 = new JLabel("");
		l10 = new JLabel("Brand: Boat");
		l11 = new JLabel("Model: B65");
		l12 = new JLabel("Price: 4600tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/hsw.jpg"));
		l15 = new JLabel("");
		l16 = new JLabel("Brand: Huawei");
		l17 = new JLabel("Model: HM13");
		l18 = new JLabel("Price: 750tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/xsw.jpg"));
		l21 = new JLabel("");
		l22 = new JLabel("Brand: Xiaomi");
		l23 = new JLabel("Model: Mibro3");
