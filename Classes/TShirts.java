...
public class TShirts
{
	...
	TShirts()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/t1.jpg"));
		l3 = new JLabel("T-Shirt");
		l4 = new JLabel("Brand: MAn");
		l5 = new JLabel("Size: M,L,S,XL,XLL");
		l6 = new JLabel("Price: 550tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/t2.jpg"));
		l9 = new JLabel("T-Shirt");
		l11 = new JLabel("Brand: Vactor");
		l10 = new JLabel("Size: M,L,S,XL,XLL");
		l12 = new JLabel("Price: 960tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/t3.jpg"));
		l15 = new JLabel("T-Shirt");
		...
		l20 = new JLabel();
        l20.setIcon(new ImageIcon("timage/4.jpg"));
		l21 = new JLabel("T-Shirt");
		l22 = new JLabel("Brand: victor");
		l23 = new JLabel("Size: M,L,S,XL,XLL");
		l24 = new JLabel("Price: 1450tk");
