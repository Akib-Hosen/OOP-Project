...
public class  Panjabi
{
	...
	Panjabi()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/l1.jpg"));
		l3 = new JLabel("Panjabi");
		l4 = new JLabel("Brand: Orobindu");
		l5 = new JLabel("Size: M,L,S,XL,XLL");
		l6 = new JLabel("Price: 1750tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/l2.jpg"));
		l9 = new JLabel("Panjabi");
		l11 = new JLabel("Brand: Vactor");
		l10 = new JLabel("Size: M,L,S,XL,XLL");
		l12 = new JLabel("Price: 1960tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/l3.jpg"));
		l15 = new JLabel("Panjabi");
		l16 = new JLabel("Brand: Pollo");
		l17 = new JLabel("Size: M,L,S,XL,XLL");
		l18 = new JLabel("Price: 2200tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/l4.jpg"));
		l21 = new JLabel("Panjabi");
		l22 = new JLabel("Brand: victor");
		l23 = new JLabel("Size: M,L,S,XL,XLL");
		l24 = new JLabel("Price: 1250tk");
