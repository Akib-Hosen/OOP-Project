...
public class Speakers
{
	...
	Speakers()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/bsp.jpg"));
		l3 = new JLabel("Portable Speaker");
		l4 = new JLabel("Brand: Boat");
		l5 = new JLabel("");
		l6 = new JLabel("Price: 2190tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/msp.jpg"));
		l9 = new JLabel("Mini Speaker");
		l10 = new JLabel("Brand: MLab");
		l11 = new JLabel("");
		l12 = new JLabel("Price: 600tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/wsp.jpg"));
		l15 = new JLabel("Room Theatre");
		l16 = new JLabel("Brand: Booshman");
		l17 = new JLabel("");
		l18 = new JLabel("Price: 2250tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/jsp.jpg"));
		l21 = new JLabel("Bluetooth Speaker");
		l22 = new JLabel("Brand: JBL");
		l23 = new JLabel("");
		l24 = new JLabel("Price: 45000tk");
