...
public class  Gabardine
{
	...
	Gabardine()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/y1.jpg"));
		l3 = new JLabel("pant");
		l4 = new JLabel("Brand: pox");
		l5 = new JLabel("Size: M,L,S,XL,XLL");
		l6 = new JLabel("Price: 1550tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/y2.jpg"));
		l9 = new JLabel("pant");
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/y3.jpg"));
		l15 = new JLabel("pant");
		l16 = new JLabel("Brand: Premio");
		l17 = new JLabel("Size: M,L,S,XL,XLL");
		l18 = new JLabel("Price: 2300tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/y4.jpg"));
		l21 = new JLabel("pant");
		l22 = new JLabel("Brand: victor");
		l23 = new JLabel("Size: M,L,S,XL,XLL");
		l24 = new JLabel("Price: 3150tk");
