...
public class CasualShoe
{
	...
	CasualShoe()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/airj.jpg"));
		l3 = new JLabel("Hihg Neck Sneakers");
		l4 = new JLabel("Brand: Nike");
		l5 = new JLabel("Size: 9-10");
		l6 = new JLabel("Price: 12950tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/puma.jpg"));
		l9 = new JLabel("Sneakers");
		l10 = new JLabel("Brand: Puma");
		l11 = new JLabel("Size :8-10");
		l12 = new JLabel("Price: 7500tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/acics.jpg"));
		l15 = new JLabel("Running Shoes");
		l16 = new JLabel("Brand: Acics");
		l17 = new JLabel("Size :6-9");
		l18 = new JLabel("Price: 3450tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/lof.jpg"));
		l21 = new JLabel("Loafer");
		l22 = new JLabel("Brand: Bata");
		l23 = new JLabel("Size :8-10");
		l24 = new JLabel("Price: 1990tk");
