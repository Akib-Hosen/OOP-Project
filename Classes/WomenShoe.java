...
public class WomenShoe
{
	...
	WomenShoe()
	{
		...
		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/gs2.jpg"));
		l15 = new JLabel("Running Shoes");
		l16 = new JLabel("Brand: Soha");
