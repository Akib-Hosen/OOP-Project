...
public class Headphones
{
	...
	Headphones()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/bhp.jpg"));
		l3 = new JLabel("");
		l4 = new JLabel("Brand: Bose");
		l5 = new JLabel("");
		l6 = new JLabel("Price: 7080tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/jhp.jpg"));
		l9 = new JLabel("");
		l10 = new JLabel("Brand: JBL");
		l11 = new JLabel("");
		l12 = new JLabel("Price: 21000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/php.jpg"));
		l15 = new JLabel("");
		l16 = new JLabel("Brand: Panasonic");
		l17 = new JLabel("");
		l18 = new JLabel("Price: 4500tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/shp.jpg"));
		l21 = new JLabel("");
		l22 = new JLabel("Brand: Sony");
		l23 = new JLabel("");
		l24 = new JLabel("Price: 4990tk");
