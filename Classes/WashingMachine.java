...
public class WashingMachine
{
	...
	WashingMachine()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/lwm.jpg"));
		l3 = new JLabel("");
		l4 = new JLabel("Brand: LG");
		l5 = new JLabel("Size: 60Liter");
		l6 = new JLabel("Price: 20800tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/pwm.jpg"));
		l9 = new JLabel("");
		l10 = new JLabel("Brand: Panasonic");
		l11 = new JLabel("Size :65Liter");
		l12 = new JLabel("Price: 22000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/swm.jpg"));
		l15 = new JLabel("");
		l16 = new JLabel("Brand: Singer");
		l17 = new JLabel("Size :80Liter");
		l18 = new JLabel("Price: 27500tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/wwm.jpg"));
		l21 = new JLabel("");
		l22 = new JLabel("Brand: Walton");
		l23 = new JLabel("Size :75Liter");
		l24 = new JLabel("Price: 23000tk");
