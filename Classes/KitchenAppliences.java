...
public class KitchenAppliences
{
	JFrame frame;
	...
	KitchenAppliences()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/wb.jpg"));
		l3 = new JLabel("Blender");
		l4 = new JLabel("Brand: Walton");
		l5 = new JLabel("Size: 2Liter");
		l6 = new JLabel("Price: 2080tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/mw.jpg"));
		l9 = new JLabel("Oven");
		l10 = new JLabel("Brand: Miyako");
		l11 = new JLabel("Size :15Liter");
		l12 = new JLabel("Price: 14000tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/induc.jpg"));
		l15 = new JLabel("Induction Stove");
		l16 = new JLabel("Brand: Vision");
		l17 = new JLabel("Size :27Inch");
		l18 = new JLabel("Price: 2950tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/krc.jpg"));
		l21 = new JLabel("Rice Cooker");
		l22 = new JLabel("Brand: Kiam");
		l23 = new JLabel("Size : 2.8Liter");
		l24 = new JLabel("Price: 3290tk");
