...
public class Salt
{
	...
	Salt()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/fresh.jpg"));
		l3 = new JLabel("Fresh Super Salt");
		l4 = new JLabel("Brand: Fresh");
		l5 = new JLabel("Weight: 1kg");
		l6 = new JLabel("Price: 65tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/molla.jpg"));
		l9 = new JLabel("Molla Super Salt");
		l10 = new JLabel("Brand: Molla group");
		l11 = new JLabel("Weight: 1kg");
		l12 = new JLabel("Price: 58tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/confi.jpg"));
		l15 = new JLabel("Confidence Super Salt");
		l16 = new JLabel("Brand: Sisty");
		l17 = new JLabel("Weight: 1kg");
		l18 = new JLabel("Price: 55tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/aci.jpg"));
		l21 = new JLabel("ACI Salt");
		l22 = new JLabel("Brand: ACI");
		l23 = new JLabel("Weight: 1kg");
		l24 = new JLabel("Price: 52tk");
