...
public class Tennis
{
	...
	Tennis()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/Recate.jpg"));
		l3 = new JLabel("Racket");
		l4 = new JLabel("Brand: Glover");
		l5 = new JLabel("Weight: 1kg");
		l6 = new JLabel("Price: 550tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/ball(1).jpg"));
		l9 = new JLabel("Ball");
		l10 = new JLabel("Brand: SS");
		l11 = new JLabel("Weight: 100gm");
		l12 = new JLabel("Price: 60tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/Equipment1.jpg"));
		l15 = new JLabel("Equipment");
		l16 = new JLabel("Brand: Poll");
		l17 = new JLabel("Weight: 5kg");
		l18 = new JLabel("Price: 8000tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/Tennis table.jpg"));
		l21 = new JLabel("Tennis Table");
		l22 = new JLabel("Brand:Glover");
		l23 = new JLabel("Weight: 15kg");
		l24 = new JLabel("Price: 7000tk");
