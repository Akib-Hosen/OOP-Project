...
public class Meat
{
	...
	Meat()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/poltri.jpg"));
		l3 = new JLabel("Firm Fresh Poltri");
		l4 = new JLabel("With Skin");
		l5 = new JLabel("Weight: 1kg");
		l6 = new JLabel("Price: 350tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/beef.jpg"));
		l9 = new JLabel("Shahiwal Beef");
		l10 = new JLabel("Steak size");
		l11 = new JLabel("Weight: 1kg");
		l12 = new JLabel("Price: 850tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/mutton.jpg"));
		l15 = new JLabel("Black Bengal");
		l16 = new JLabel("Fat cut");
		l17 = new JLabel("Weight: 1kg");
		l18 = new JLabel("Price: 1100tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/desichicken.jpg"));
		l21 = new JLabel("Organic Desi Chicken");
		l22 = new JLabel("Antibiotic Free");
		l23 = new JLabel("Weight: 1kg");
		l24 = new JLabel("Price: 520tk");
