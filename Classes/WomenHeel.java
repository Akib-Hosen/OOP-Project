...
public class WomenHeel
{
	...
	WomenHeel()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/hil1.jpg"));
		l3 = new JLabel("Color: Blue");
		l4 = new JLabel("Brand: Papaya");
		l5 = new JLabel("Size: 6-8");
		l6 = new JLabel("Price: 28180tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/hil2.jpg"));
		l9 = new JLabel("Color: Black");
		l10 = new JLabel("Brand: Malina");
		l11 = new JLabel("Size :6-9");
		l12 = new JLabel("Price: 5200tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/hil3.jpg"));
		l15 = new JLabel("Color: Silver");
		l16 = new JLabel("Brand: Airas");
		l17 = new JLabel("Size :6-9");
		l18 = new JLabel("Price: 2250tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/hil4.jpg"));
		l21 = new JLabel("Color: Black");
		l22 = new JLabel("Brand: Jiana's");
		l23 = new JLabel("Size :6-8");
		l24 = new JLabel("Price: 3990tk");
