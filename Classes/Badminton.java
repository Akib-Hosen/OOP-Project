...
public class Badminton
{
	...
	Badminton()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/Bad.jpg"));
		l3 = new JLabel("Racate");
		l4 = new JLabel("Brand: SS");
		l5 = new JLabel("Weight: 900gm");
		l6 = new JLabel("Price: 550tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/Suttle.jpg"));
		l9 = new JLabel("Shuttle");
		l10 = new JLabel("Brand: Pollo");
		...
		l18 = new JLabel("Price: 200tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/Shoes.jpg"));
		l21 = new JLabel("Shoes");
		l22 = new JLabel("Brand: LPtto");
		l23 = new JLabel("Weight: 1kg");
		l24 = new JLabel("Price: tk");
