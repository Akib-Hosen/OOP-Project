...
public class Jersey
{
	...
	Jersey()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/jer1.jpg"));
		l3 = new JLabel("Jersey");
		l4 = new JLabel("Brand: Lotto");
		l5 = new JLabel("Weight: 200gm");
		l6 = new JLabel("Price: 550tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/Foot.jpg"));
		l9 = new JLabel("Football jersey");
		l10 = new JLabel("Brand: Royal");
		l11 = new JLabel("Weight: 300gm");
		l12 = new JLabel("Price: 700tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/Cri.jpg"));
		l15 = new JLabel("Cricket jersey");
		l16 = new JLabel("Brand: Glover");
		l17 = new JLabel("Weight: 300gm");
		l18 = new JLabel("Price: 1200tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/jer2.jpg"));
		l21 = new JLabel("Jersey");
		l22 = new JLabel("Brand: Vactor");
		l23 = new JLabel("Weight: 200gm");
		l24 = new JLabel("Price: 350tk");
