...
public class Football
{
	...
	Football()
	{
		...
		l2 = new JLabel();
        l2.setIcon(new ImageIcon("image/Football.jpg"));
		l3 = new JLabel("Football");
		l4 = new JLabel("Brand: SS");
		l5 = new JLabel("Weight: 800gm");
		l6 = new JLabel("Price: 550tk");
		l7 = new JLabel("Quantity:");

		l8 = new JLabel();
        l8.setIcon(new ImageIcon("image/shoulder.jpg"));
		l9 = new JLabel("Shoulders pad");
		l10 = new JLabel("Brand: Marin");
		l11 = new JLabel("Weight: 800gm");
		l12 = new JLabel("Price: 600tk");
		l13 = new JLabel("Quantity:");

		l14 = new JLabel();
        l14.setIcon(new ImageIcon("image/Equipment.jpg"));
		l15 = new JLabel("Equipment");
		l16 = new JLabel("Brand: Poll");
		l17 = new JLabel("Weight: 5kg");
		l18 = new JLabel("Price: 3999tk");
		l19 = new JLabel("Quantity:");

		l20 = new JLabel();
        l20.setIcon(new ImageIcon("image/Gloves.jpg"));
		l21 = new JLabel("Gloves");
		l22 = new JLabel("Brand: Pollo");
		l23 = new JLabel("Weight: 400gm");
		l24 = new JLabel("Price: 450tk");
